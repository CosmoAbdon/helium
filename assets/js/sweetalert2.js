...
//This javascript was changed by Creative Tim for working with our design
;(function(window, document) {
  ...
  function modalDependant() {
    ...
    //  Creative tim edit: commented all these javascript changes because we trigger them by CSS clasess by default.
    ...
    // Creative Tim: commented for not overwriting our CSS classes
  ...
  function setParameters(params) {
    ...
    // Creative Tim edit: we add the background color if there is no Class on the button
    if(!params.confirmButtonClass){
        $confirmBtn.style.backgroundColor = params.confirmButtonColor;
    }

    // Creative Tim edit: we add the background color if there is no Class on the button
    if(!params.cancelButtonClass){
